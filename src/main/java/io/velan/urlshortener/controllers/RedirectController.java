...
// ..... field injection using autowired (not recommeded - hard to test, hidden dependency, break immutatibility).....
//     @Autowired
...
public class RedirectController {
    ...
    // constructor based dependency injection (no need for @Autowired as spring injects it automatically) RECOMMENDED !!
